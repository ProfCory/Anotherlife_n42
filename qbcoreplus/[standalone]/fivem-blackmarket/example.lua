...
-- FROM SERVER SIDE 
-- TriggerClientEvent('fivem-blackmarket:addtaskcount', source, taskId, count)

---------------------------------------------

-- ADD EXPERIENCE :

-- FROM CLIENT SIDE; TriggerServerEvent('fivem-blackmarket:addXP', 1000) -- 1000 xp amount to be added 
...
RegisterCommand('tasktry', function()
    ...
    TriggerServerEvent('fivem-blackmarket:taskCountAdd', 1, 1)
end)
