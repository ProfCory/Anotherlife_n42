...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 5000, bank = 100, crypto = 100 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto' }                -- Money that is not allowed going in minus
QBConfig.Money.MinusLimit = -50000                                    -- The maximum amount you can be negative 
