...
Config.HealthDamage = 25                                      -- Minumum damage done to health before checking for injuries
...
Config.AlwaysBleedChance = 20                                -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
