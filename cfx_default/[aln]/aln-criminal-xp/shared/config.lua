Config = Config or {}
Config.Criminal = Config.Criminal or {}

Config.Criminal.XPMax = 15000

Config.Criminal.Bands = {
...
Config.Criminal.NextAdvEnabled = true
Config.Criminal.NextAdvTTLSeconds = 300
